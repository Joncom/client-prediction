    ...
    */
    ...
    PredictTest = ig.Class.extend({ // public class PredictTest extends JComponent {
        ...
        main: function(args) { // public static void main(String[] args) {
            ...
            new Thread(new ig.Class.extend({ // new Thread(new Runnable() {
        ...
        Client: new ig.Class.extend({ // static class Client {
        ...
        Server: new ig.Class.extend({ // static class Server {
        ...
        DelayedFifo: new ig.Class.extend({ // static class DelayedFifo<T> {
