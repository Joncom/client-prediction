...
.defines(function(){
    ...
    PredictedState = ig.Class.extend({ // static class PredictedState {
        ...
        update: function(timedInput, correctState) { // void update(TimedInput timedInput, TimedState correctState) {
            ...
            this.moveList.add(move); // moveList.add(move);
            currentState = this.moveList.correct(currentState, correctState); // currentState = moveList.correct(currentState, correctState);
        }
    });
